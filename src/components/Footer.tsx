    ...
    <footer className="mt-8 border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:px-6 md:flex-row md:justify-between">
        <div className="max-w-sm">
          <span className="font-display text-xl font-black text-foreground">
            Garden State <span className="text-accent">Digest</span>
          </span>
          <p className="mt-3 text-sm text-muted">
            A New Jersey desk covering education, healthcare, business
      ...
      <div className="border-t border-border px-4 py-5 sm:px-6">
        <p className="mx-auto max-w-6xl text-xs text-muted">
          &copy; {year} Garden State Digest. All rights reserved. A sample
